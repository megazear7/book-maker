import { BookId, ChapterNumber, ChapterOutline, ChapterParts } from "../types/book.type.js";
...
export async function createChapter(book: BookId, chapter: ChapterNumber): Promise<ChapterParts> {
    toggleLoading();
