...
export const InputTokenCount = z.number().min(0).describe("The number of input tokens to use when counting input cost.");
...
export const OutputTokenCount = z.number().min(0).describe("The number of output tokens to use when counting output cost.");
